    ...
    <FileSystemProvider initialData={project?.data}>
      <ChatProvider projectId={project?.id} initialMessages={project?.messages}>
        <div className="h-screen w-screen overflow-hidden bg-neutral-50">
          <ResizablePanelGroup id="main-group" direction="horizontal" className="h-full">
            {/* Left Panel - Chat */}
            <ResizablePanel id="main-left" defaultSize={35} minSize={25} maxSize={50}>
            ...
            <ResizablePanel id="main-right" defaultSize={65}>
              <div className="h-full flex flex-col bg-white">
                {/* Top Bar */}
